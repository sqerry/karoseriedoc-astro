...
uspItems:
  - text: 'Plnění klimatizací – starší chladivo R134a i nové ekologické 1234yf'
  - text: 'Detekce a opravy úniků chladiva'
  - text: 'Dezinfekce ozonem a výměna kabinového filtru'
  - text: 'Opravy a výměny kompresorů včetně proplachu systému'
  - text: 'K dispozici oba chladírenské plyny R-134a a R-1234yf'
  - text: 'Předělání ze starého plynu R12 na vašem veteránu na nový typ chladiva R-134a'
lang: 'cs'
---
...
**Plnění klimatizací (Staré i nové chladivo):** Odsajeme staré chladivo, vakuujeme systém (zbavíme ho vlhkosti) a naplníme přesným množstvím nového chladiva i s potřebným olejem pro kompresor. Zvládáme jak starší typ chladiva (R134a), tak i nové, ekologické (1234yf).

**Detekce a opravy úniků:** Ztrácí se vám chladivo podezřele rychle? Natlakujeme systém dusíkem nebo použijeme UV barvivo a speciální lampu, abychom přesně našli místo úniku. Děravé trubky, chladiče (kondenzátory) nebo těsnění následně vyměníme.

**Dezinfekce ozonem a výměna filtru:** Zápach způsobují bakterie a plísně na výparníku. Pomocí výkonného generátoru ozonu zničíme 99,9 % bakterií a virů v celém interiéru. Samozřejmostí je výměna kabinového (pylového) filtru.
...
**Prevence drahých oprav:** Málo chladiva znamená i málo mazacího oleje. Kompresor běží "nasucho", přehřívá se a může se zadřít. Jeho výměna pak stojí desetitisíce.

**Zdraví na prvním místě:** Nečištěná klimatizace fouká do kabiny spory plísní, což způsobuje alergie, pálení očí a únavu za volantem.
